...
-- Left "Error in $: When parsing the record Human of type Chapter0706.Human the key name was not present."
...
-- >>> encode $ nameList !! 0
-- "{\"name\":\"General Affairs\",\"coworkers\":[{\"name\":\"Taro\",\"age\":30},{\"name\":\"Matsuko\",\"age\":26}]}"
...
nameListValue =
  Array
    [ object
        [ "coworkers"
            .= Array
              [ object ["age" .= Number 20, "name" .= String "Satoshi"],
                object ["age" .= Number 23, "name" .= String "Takeshi"]
              ],
...
-- "[{\"coworkers\":[{\"name\":\"Satoshi\",\"age\":20},{\"name\":\"Takeshi\",\"age\":23}],\"departmentName\":\"Planning\"}]"
